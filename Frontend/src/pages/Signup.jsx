...
//     e.preventDefault(); //to not let page refresh
...
function Signup() {
  ...
  }, [isAuthenticated,navigate]); //navigate rakho na rakho, don't affect, since, it just prefer to keep a constant value here . so, we put it but no need
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-base-200"> {/* Centering container */}
      <div className="card w-96 bg-base-100 shadow-xl"> {/* Existing card styling */}
        <div className="card-body">
          <h2 className="card-title justify-center text-3xl mb-6">Leetcode</h2> {/* Centered title */}
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-control">
              ...
              <input type="text" placeholder="John" className={`input input-bordered w-full ${errors.firstName ? 'input-error': ''}`}
                {...register('firstName')}
              />
            ...
            <div className="form-control  mt-4">
              ...
              <input type="email" placeholder="john@example.com" className={`input input-bordered w-full ${errors.emailId ? 'input-error': ''}`}
                {...register('emailId')}
              />
            ...
            <div className="form-control mt-4">
              ...
              <input type={showPassword? "text": "password"} placeholder="••••••••" className={`input input-bordered w-full pr-10 ${errors.password ? 'input-error': ''}`}
                {...register('password')}
              />
              <button type="button"
