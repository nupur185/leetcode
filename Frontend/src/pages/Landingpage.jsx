...
import {
  ...
  Loader2, Sparkles, CheckCircle2, Bot,ScrollText, Lightbulb
} from 'lucide-react';
...
const EXPLORE = [
  ...
  { icon: ScrollText, title: 'CheatSheets', desc: 'Useful CheatSheets for Interview Preparation for top tech companies.' },
];
...
const PRODUCT = [
  ...
  { icon: Cpu, title: '20+ languages', desc: 'C++, Java, Python, Go, Rust and more — compiled in the cloud.' },
  { icon: Gauge, title: 'Progress tracking', desc: 'Visualize streaks, mastery and weak spots with rich analytics.' },
  { icon: Lightbulb, title: 'Live chat & AI help', desc: 'Pair with another developer in real time, or get unstuck instantly with the built-in AI assistant.' },
  { icon: ScrollText, title: 'Cheatsheets', desc: 'Battle-tested reference sheets for patterns, complexity and syntax — one click away.' },
];
